...
class Gestures {
     ...
     */
    public static swipeContentDown(percentage = 1): void {
        browser.pause(2000);
     ...
     * @param {number} percentage from 0 - 1
     */
    public static swipeContentUp(percentage: number = 1): void {
        browser.pause(2000);
        Gestures.swipeOnPercentage(
     ...
     * @param {number} percentage from 0 - 1
     */
    public static swipeLeft(percentage = 1) {
        Gestures.swipeOnPercentage(
     ...
     * @param {number} percentage from 0 - 1
     */
    public static swipeRight(percentage: number = 1): void {
        Gestures.swipeOnPercentage(
    ...
    public static checkIfDisplayedWithScrollDown(element: WebdriverIO.Element, maxScrolls: number, amount: number = 0) {
     ...
     */
    public static tapNativeElement(element: WebdriverIO.Element): void {
    ...
    public static tapWebviewElement(element: WebdriverIO.Element): void {
    ...
    public static dragAndDropWebviewElement(element: WebdriverIO.Element, right: number = 0, up: number = 0, adjustBySize: boolean = true): void {
        const { x, y } = element.getLocation();
        let width = 0;
        let height = 0;
    ...
    public static scrollIntoView(element: WebdriverIO.Element) {
        ...
        } else throw Error('Element does not exist in the DOM - review test case' + element);*/
        ...
        try {
            if (element.isExisting()) {
                ...
                browser.waitUntil(
                    ...
                    5000,
                    `ERROR:element ${element} still display after waiting for ${5000 / 1000}s`
                );
            }
        } catch (e) {
            throw Error.captureStackTrace(element);
        }
    }

    public static clickAndWaitForNotDisplay(element: WebdriverIO.Element) {
